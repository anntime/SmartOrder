...
(2, 1, 3, '水煮鱼123', '水煮鱼又称江水煮江鱼，是一道重庆市的汉族创新名菜，属于重庆渝北风味。最早流行于重庆、四川等地。看似原始的做法，实际做工考究--选新鲜生猛活鱼，又充分发挥辣椒御寒、益气养血功效，烹调出来的肉质一点也不会变韧，口感滑嫩，油而不腻。既去除了鱼的腥味，又保持了鱼的鲜嫩。满目的辣椒红亮养眼，辣而不燥，麻而不苦。“麻上头，辣过瘾”，让水煮鱼在全国流 行。', 91, '盘', '普通', '/SmartOrder/Data/Uploads/Images/54fa5da4c9383.jpg', 0, 1440822025),
...
(12, 1, 2, '糖醋小排', '糖醋小排，超级好吃，我最喜欢的一道菜~~~', 76, '盘', '普通', '', 0, 1440816916),
(13, 2, 6, '葱花饼', '', 0, '', '', '', 0, 0),
(14, 2, 7, '烤鱼', '', 0, '', '', '', 0, 0),
(15, 2, 8, '松花蛋', '', 0, '', '', '', 0, 0),
(16, 2, 9, '大闸蟹', '', 0, '', '', '', 0, 0);
...
INSERT INTO `department` (`id`, `com_id`, `dept_key`, `last_menu_time`, `last_order_time`, `dept_name`, `dept_charge_name`, `dept_charge_tel`, `dept_charge_id`, `dept_charge_email`, `dept_charge_add`, `dept_charge_deta_add`, `business_license`) VALUES
(1, '1', 'dsas', '', '', '', '', '', '', '', '', '', '');
