...
<body>
    ...
    <div id="main-content">
        ...
        <form action="<?php echo U('/MenuManage/ModifyCookMenu','','');?>" method="post" class="form-horizontal">
            <div class="form-item">
                <label class="item-label">选择菜系<?php echo ($info["cookname"]); ?><span class="check-tips"></span></label>
                <div class="controls" <?php echo ($styleid = $info["styleid"]); ?>>
                <select name="styleid">
                    <?php if(is_array($CookStyle)): foreach($CookStyle as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if(($v["id"] == $styleid)): ?>selected="selected"<?php endif; ?>><?php echo ($v["stylename"]); ?></option><?php endforeach; endif; ?>      
                </select>  
                </div>
            </div>
            <div class="form-item">
                ...
                <div class="controls">
                    <input type="text" class="text input" name="cookname" value="<?php echo ($info["cookname"]); ?>"/>
                </div>
            </div>
            <div class="form-item">
            ...
            <div class="form-item">
                ...
                <label class="textarea input-large">
                    ...
                    <input type="text" class="text input" style="display:none" name="cookid" value="<?php echo ($info["id"]); ?>"/>
                </label>                
                </div>
            </div>
            <div class="form-item">
